...
const translations = {
  ...
  fr: {
    ...
    'nav.faq':          'FAQ',
    'nav.discovery':    'Fixer un RDV',
    'mobilenav.p': 'Disponible pour discuter des opportunités',
    'mobilenav.cta' : 'Me contacter',

    // ── Page À propos ─────────────────────────────
    'about.hero.label':  'À propos',
    'about.hero.intro':  'Je suis Jacob — Je suis concepteur de produits senior et j\'ai 10 ans d\'expérience dans la conception de produits, de systèmes et d\'interfaces numériques à grande échelle.',
    'about.hero.p1':     'J\'ai commencé ma carrière à Madagascar, au sein d\'Axian Group, l\'un des plus grands groupes panafricains, actif dans les télécoms, l\'énergie et la fintech. Pendant 5 ans, j\'ai piloté la refonte complète de l\'identité visuelle du groupe, unifier 5 secteurs sous une marque commune, et contribué à 4 prix internationaux aux Creatives 974 Awards.',
    'about.hero.p2':     'J\'ai ensuite rejoint Tango, l\'opérateur télécom leader au Luxembourg. J\'y ai conçu l\'expérience utilisateur de l\'app mobile (gestion des offres, fidélisation, paiements) et du site e-commerce en maintenant une cohérence totale entre les deux plateformes à travers un design system partagé.',
    'about.hero.p3':     'Mon dernier projet : Venue (Yummy Labs / Superbloom), un jeu mobile à 4M+ joueurs, récompensé Top Sprinter en mars 2026.',
    'about.stats.exp':   '10 ans',
    'about.stats.exp.label':     'd\'expérience',
    'about.stats.countries':     '3 pays',
    'about.stats.countries.label': 'Madagascar · Luxembourg · France',
    'about.stats.focus':         'SaaS · Fintech',
    'about.stats.focus.label':   'Secteurs de prédilection',
    'about.approach.h2':         'Comment je travaille',
    'about.approach.v1.title':   'Problèmes d\'abord',
    'about.approach.v1.desc':    'Je ne commence pas par Figma. Je commence par comprendre vos utilisateurs, vos contraintes et votre business. Les pixels viennent après.',
    'about.approach.v2.title':   'Collaboration réelle',
    ...
    'about.faq.cta.sub':         'Parlons-en directement — c\'est gratuit et sans engagement.',
    'about.faq.cta.btn':         'Prendre rdv gratuitement',
    'about.cta.h2':              'Disponible pour discuter des opportunités',
    'about.cta.p':               'Vous avez un produit à construire ou à améliorer ? Réservez un appel de 30 minutes — gratuit, sans engagement.',
    'about.cta.btn':             'Voir mes disponibilités',

    // ── Hero ─────────────────────────────────────
    'h1.1':         'Product designer',
    'hero.quote':   '10 ans en design. Madagascar → Luxembourg → France',
    'hero.subtitle':'Autodidacte. Prouvé loin de chez moi.<br/> En laissant toujours mon empreinte \'digitale\' 😉.<br/> Je transforme les  systèmes complexes en interfaces claires et intuitives. Mon travail est axé sur les design system, la clarté des produits et l\'impact mesurable.<br> J\'utilise l\'IA pour itérer plus vite, explorer des solutions et réduire la distance entre idée et produit',
    'hero.cta':     'Voir mes disponibilités',
    ...
    'quote.text':        'Senior Product designer <br><span> Systèmes complexes, Design system et clarté des produits</span>',
    ...
    // ── Bandeau principal ─────────────────────────
    'main.h2':      'Je travaille sur l\'ensemble du processus, de la phase de découverte jusqu\'à la livraison du produit, en étroite <span>collaboration avec les équipes produit et ingénierie.</span>',
    'main.subtitle':'Fixez un rendez-vous avec moi par Visio, Je suis disponible pour discuter des opportunités.',
    ...
    'casestudies.tango.desc':     'Gouvernance design system.',
    'casestudies.tango.hero.locked': 'Gouvernance design system',
    'cs.tango.pw.title':             'Case study protégé',
    'cs.tango.pw.sub':               'Contenu protégé sous NDA — accès par mot de passe',
    'cs.tango.input.pass':           '<input type="password" id="pw-input" class="pw-input" placeholder="Mot de passe" autocomplete="current-password" onkeydown="if(event.key===\'Enter\') checkTangoPassword()" aria-label="Mot de passe" >', 
    'cs.tango.pw.error':             'Mot de passe incorrect.',
    'cs.tango.pw.btn':               'Voir le case study →',
    'casestudies.checkout.title':        'Checkout',
    'casestudies.checkout.desc':         'Simplifier le funnel d\'achat pour réduire les abandons.',
    'casestudies.axian.title':           'Brand &amp; Web Design',
    'casestudies.axian.desc':            'Concevoir l\'autorité digitale d\'un groupe panafricain opérant sur 5 clusters.',
    'casestudies.axian.upcoming':        'À venir',
    'casestudies.silva.title':           'Web Design',
    ...
    'cs.venue.hero.sub':                'UX Case Study · Design de jeu mobile · Stratégie de rétention · Systèmes sociaux · Product Design',
    ...
    'cs.venue.meta.constraint.value':   'Sprint de 2 semaine',
    ...
    'cs.venue.problem.p1':              'Elle joue depuis des mois. Elle crée des pièces, les soumet au vote, accumule des récompenses. Elle est engagée. Mais quand elle veut un retour ou de la reconnaissance, le produit n\'a rien à lui offrir. Alors elle va ailleurs.',
    ...
    'cs.venue.problem.conclusion.lead':      'Le produit manquait d\'une boucle de feedback social qui donnait du sens à l\'activité des joueuses.',
    'cs.venue.problem.conclusion.sub':       'Cela a créé un problème UX structurel :',
    'cs.venue.problem.conclusion.li1':       'Pas de reconnaissance in-app après soumission',
    'cs.venue.problem.conclusion.li2':       'Pas de visibilité sur l\'engagement des autres joueuses',
    'cs.venue.problem.conclusion.li3':       'Pas de contexte social persistant auquel revenir',
    'cs.venue.problem.conclusion.challenge': 'UX Challenge : Comment concevoir des fonctionnalités sociales qui améliorent la rétention sans ajouter de friction ni de complexité de modération ?',
    'cs.venue.h2.insight':              'L\'Insight',
    'cs.venue.insight.lead':            'La plupart des fonctionnalités sociales des jeux mobiles reposent sur des actions explicites : rejoindre des groupes, ajouter des amis ou publier du contenu. Mais cela crée des frictions. Les joueuses comme Beth ne veulent pas avoir à « faire » de l\'interaction sociale ; ils veulent la ressentir naturellement.',
    ...
    'cs.venue.challenge.lead':          'Le brief de SuperBloom : concevoir pour Venue un système social de groupe qui encourage la collaboration, améliore la fidélisation des joueurs (J7 / J30), ne nécessite aucune modération et n\'impose aucune charge cognitive supplémentaire',
    ...
    'cs.venue.principle.2.title':       'Aucune pénalité pour les absences',
    ...
    'cs.venue.principle.3.title':       'Participation passive',
    ...
    'cs.venue.principle.4.title':       'Progression collective',
    ...
    'cs.venue.h2.joining':              'La Mécanique d\'adhésion : "Appartenance sans friction"',
    ...
    'cs.venue.joining.blockquote':      '<strong> Décision Produit :</strong> Suppression de toutes les étapes d\'adhésion volontaire afin d\'éliminer les obstacles et de favoriser l\'engagement dès le début.',
    ...
    'cs.venue.d7.blockquote':           '<strong> Décision Produit :</strong> Intégration de la découverte des fonctionnalités dans le flux utilisateur existant, plutôt que d\'utiliser des notifications ou des invitations externes.',
    'cs.venue.h2.currencies':           'Design de rétention',
    ...
    'cs.venue.currencies.blockquote':     '<strong> Décision Produit :</strong> Des cycles d\'engagement distincts (hebdomadaires et à long terme) pour prendre en charge les deux cycles de fidélisation.',
    ...
    'cs.venue.voting.blockquote':       '<strong> Décision Produit :</strong> Suppression des interactions sous forme de texte libre afin d\'éliminer les besoins en modération tout en conservant les réactions émotionnelles.',  
    ...
    'cs.venue.h2.rollout':              'Comment ça se déploierait',
    'cs.venue.rollout.lead':            'Ce système n\'a pas été conçu pour être livré d\'un seul coup.',
    'cs.venue.rollout.body':            'Il est structuré pour être introduit progressivement — chaque phase validant une couche différente de l\'expérience avant d\'ajouter de la complexité.',
    'cs.venue.phase1.label':            'Phase 1',
    'cs.venue.phase1.badge':            'Valider l\'appartenance (J7)',
    'cs.venue.phase1.desc':             'Démarrer avec une assignation légère au Studio et une contribution passive.',
    'cs.venue.phase1.goal':             'Tester la progression partagée · Rétention précoce',
    'cs.venue.phase2.label':            'Phase 2',
    'cs.venue.phase2.badge':            'Approfondir l\'engagement',
    'cs.venue.phase2.desc':             'Introduire les réactions et la visibilité de la galerie.',
    'cs.venue.phase2.goal':             'Augmenter la fréquence de contribution',
    'cs.venue.phase3.label':            'Phase 3',
    'cs.venue.phase3.badge':            'Construire l\'attachement long terme (J30)',
    'cs.venue.phase3.desc':             'Ajouter une progression persistante (Studio rooms, système Flèches).',
    'cs.venue.phase3.goal':             'Créer une identité · Rétention long terme',
    'cs.venue.rollout.closing':         'Chaque phase s\'appuie sur la précédente, transformant un concept de design en système mesurable.',
    ...
    'cs.venue.learned.1.desc1':        'Décomposer les parcours utilisateurs en moments clés (rejoindre, contribuer, rester, quitter) améliore la prise de décision.',
    'cs.venue.learned.2.title':        'Les bonnes références sont des systèmes, pas des écrans.',
    'cs.venue.learned.2.desc1':        'Regarder au-delà des feeds de design a déplacé la question de "comment ça devrait ressembler ?" à "quel problème a déjà été résolu à grande échelle ?"',
    ...
    'cs.venue.learned.3.desc1':        'Utiliser Claude Code a permis un prototypage rapide et des cycles d\'itération plus courts entre concept et implémentation.',
    'cs.venue.h2.quotes':              'Principes clés que je porterai en avant',
    'cs.venue.quote.1':                'Concevoir des systèmes qui préviennent les problèmes, pas qui les gèrent',
    'cs.venue.quote.2':                'Réduire la friction en supprimant les décisions inutiles',
    'cs.venue.quote.3':                'Construire l\'appartenance par le comportement, pas par l\'interaction explicite',
    'cs.venue.h2.tools':               'Outils &amp; Méthodes',
    'cs.venue.tools.pill1':            'Figma (UI/UX design, prototypage)',
    'cs.venue.tools.pill2':            'Claude Code (prototypage rapide, tests d\'interaction)',
    'cs.venue.tools.pill3':            'Design systémique',
    'cs.venue.tools.pill4':            'Cartographie du parcours utilisateur',
    ...
    'cs.venue.tldr.title':             'TL;DR',
    'cs.venue.tldr.problem.label':     'Problème :',
    'cs.venue.tldr.problem.value':     'Absence de boucle de feedback social dans un jeu mobile',
    'cs.venue.tldr.solution.label':    'Solution :',
    'cs.venue.tldr.solution.value':    'Système social passif intégré dans le gameplay',
    'cs.venue.tldr.impact.label':      'Impact :',
    'cs.venue.tldr.impact.value':      'Amélioration de la rétention J7 et J30',
    'cs.venue.tldr.approach.label':    'Approche :',
    'cs.venue.tldr.approach.value':    'Prototypage rapide avec Figma et Claude Code',
    ...
    // ── Case Study · Tango Design System ─────────────────
    'cs.tango.back':                    '← Travaux',
    'cs.tango.hero.h1':                 'Unifier trois plateformes.<br>Bâtir le système qui tient.',
    'cs.tango.hero.sub':                'Tango Design System — Fév 2024 — Août 2025',
    'cs.tango.nda.text':                'Ce case study est partagé sous NDA. Les captures et métriques visibles sont publiques ou anonymisées. Les données internes, fonctionnalités non lancées et informations financières ont été omises.',

    'cs.tango.tldr.h2':                 'TL;DR',
    'cs.tango.tldr.card1.label':        'Problème :',
    'cs.tango.tldr.card1.p':            'Trois plateformes, trois identités visuelles, aucun langage commun. La dette design s\'accumulait à chaque livraison.',
    'cs.tango.tldr.card2.label':        'Solution :',
    'cs.tango.tldr.card2.p':            'Design system unifié construit progressivement, en parallèle des urgences produit — sans big bang, sans bloquer les équipes.',
    'cs.tango.tldr.card3.label':        'Impact :',
    'cs.tango.tldr.card3.p':            'Cohérence visuelle sur 3 plateformes. Identité de marque unifiée. Implémentation fluide sur les projets suivants.',
    'cs.tango.tldr.card4.label':        'Approche :',
    'cs.tango.tldr.card4.p':            'Itérations courtes, feedback dev structuré, anticipation des composants à revamper avant que les projets les forcent.',

    'cs.tango.meta.project.label':      'PROJECT',
    'cs.tango.meta.project.value':      'MyTango App · tango.lu · Customer Self-Care Portal',
    'cs.tango.meta.role.label':         'ROLE',
    'cs.tango.meta.role.value':         'Sole Product Designer — UX, UI & Design System',
    'cs.tango.meta.company.label':      'COMPANY',
    'cs.tango.meta.company.value':      'Tango Luxembourg (Telecom internet & mobile)',
    'cs.tango.meta.constraint.label':   'CONSTRAINT',
    'cs.tango.meta.constraint.value':   'Système considéré comme "fini" par 2 agences · Priorités produit non négociables · Seul designer',
    'cs.tango.meta.deliverables.label': 'DELIVERABLES',
    'cs.tango.meta.deliverables.value': 'Design system · Composants "Evolution" · Tokens unifiés · Specs handoff · Slide decks projet',
    'cs.tango.meta.period.label':       'PERIOD',
    'cs.tango.meta.period.value':       'Fév 2024 — Août 2025 · 1 an 7 mois',

    'cs.tango.stats.s1.label':          'plateformes unifiées',
    'cs.tango.stats.s2.label':          'vélocité dev',
    'cs.tango.stats.s3.label':          'satisfaction users',

    'cs.tango.s01.label':               '01 · Contexte',
    'cs.tango.s01.h2':                  'Seul designer. Trois produits. Simultanément.',
    'cs.tango.s01.intro':               'Tango est l\'opérateur télécom mobile et internet leader au Luxembourg.<br>Objectif : internaliser le design pour briser la dépendance aux agences externes et livrer sur 3 plateformes en parallèle.',
    'cs.tango.s01.card1.label':         'Mon rôle',
    'cs.tango.s01.card1.p':             'Product Designer intégré dans une équipe cross-fonctionnelle — PMs, ingénieurs, analystes CX. Responsable de l\'UX mobile, de l\'expérience web et de la gouvernance du design system.',
    'cs.tango.s01.card2.label':         'Point de départ',
    'cs.tango.s01.card2.p':             '3 fichiers Figma de 2 agences différentes. Aucun token partagé. Aucune gouvernance de composants. Aucun standard de handoff. Chaque plateforme avait sa propre logique visuelle.',
    'cs.tango.s01.card3.label':         'Scope',
    'cs.tango.s01.card3.p':             'MyTango App (mobile) · tango.lu (e-commerce) · Customer Self-Care Portal · Design system transverse aux 3 produits.',
    'cs.tango.s01.card4.label':         'Méthode',
    'cs.tango.s01.card4.p':             'Agile. Ateliers cross-fonctionnels hebdomadaires. Itérations basées sur les données CX, retours App Store et reviews stakeholders.',

    'cs.tango.s02.label':               '02 · Utilisateurs',
    'cs.tango.s02.h2':                  'Une particularité Tango.<br>Deux types d\'utilisateurs.',
    'cs.tango.s02.intro':               'Chaque feature designée devait fonctionner pour deux profils aux droits et aux comportements fondamentalement différents. Ignorer cette dualité, c\'est livrer un produit qui casse en production.',
    'cs.tango.s02.step1.title':         'Masterline',
    'cs.tango.s02.step1.p':             'Compte principal avec droits complets sur le compte. Nécessite une authentication. Chaque flow critique est conçu autour de lui en premier.',
    'cs.tango.s02.step1bis.title':      'Masterline vue subscriber',
    'cs.tango.s02.step1bis.p':          'Compte principal lorsqu\'il opère sur un compte rattaché.',
    'cs.tango.s02.step2.title':         'Subscriber',
    'cs.tango.s02.step2.p':             'Compte rattaché avec droits restreints. Chaque feature nécessite une version Subscriber — avec ses propres contraintes d\'affichage et de permission.',
    'cs.tango.s02.impact.label':        'Impact sur le design',
    'cs.tango.s02.impact.p':            'Chaque écran, chaque flow, chaque composant devait être pensé deux fois. Quelle information est pertinente, quelle action est autorisée, quel message d\'erreur s\'affiche, et comment transitionner proprement entre les deux états. Cette dualité est présente dans chacun des projets ci-dessous.',

    'cs.tango.s03.label':               '03 · Design System',
    'cs.tango.s03.h2':                  'Construire le système<br>en jonglant les urgences.',
    'cs.tango.s03.intro':               'Le design system ne s\'est pas construit en une fois. Il s\'est construit malgré les priorités produit, progressivement, méthodiquement, feature après feature.',
    'cs.tango.s03.sit.label':           'Situation',
    'cs.tango.s03.sit.h3':              'Trois produits. Trois identités. Zéro cohérence.',
    'cs.tango.s03.sit.body':            'Tango avait investi dans trois plateformes distinctes, conçues à des moments différents par des équipes différentes. Le résultat visible : des codes couleurs disparates, des dégradés propres à chaque produit, des tokens qui ne se parlaient pas. Le problème remontait jusqu\'au management sous une forme simple — <em class="cs-tango-emphasis">"c\'est pas le bon bleu."</em>',
    'cs.tango.s03.card1.title':         'Couleurs non unifiées',
    'cs.tango.s03.card1.p':             'Chaque plateforme avait ses propres valeurs de couleur. Un même bleu Tango existait en 3 variations selon l\'endroit.',
    'cs.tango.s03.card2.title':         'Dégradés propres au site',
    'cs.tango.s03.card2.p':             'Le site web utilisait un dégradé de couleur absent des autres produits — visuellement incohérent, jamais challengé.',
    'cs.tango.s03.card3.title':         'Tokens non partagés',
    'cs.tango.s03.card3.p':             'Les équipes dev de l\'app et du site travaillaient en silos. Aucun token commun, donc aucune source de vérité partagée.',
    'cs.tango.s03.screen1.label':       'Customer Self-Care',
    'cs.tango.s03.screen2.label':       'MyTango App',
    'cs.tango.s03.screen3.label':       'tango.lu',
    'cs.tango.s03.res.label':           'Résistance',
    'cs.tango.s03.res.h3':              'Le système était "fini". Deux agences l\'avaient dit.',
    'cs.tango.s03.res.body':            'La première résistance était positionnelle. Le design system était considéré comme livré. Proposer de le retravailler revenait à remettre en question un investissement déjà validé. Il fallait une démonstration, pas un débat.',

    'cs.tango.s04.label':               '04 · Approche',
    'cs.tango.s04.h2':                  'Pas de big bang.<br>Une première brique visible.',
    'cs.tango.s04.intro':               'J\'ai commencé par un changement précis et argumenté : supprimer le dégradé de couleur sur le site web. Une fois validé, ça a ouvert la conversation sur l\'unification plus large. Le reste s\'est construit de la même façon — une itération courte, un composant consolidé, un token aligné — sans jamais arrêter les livraisons en cours.',
    'cs.tango.s04.mh':                  'MUST HAVE',
    'cs.tango.s04.nth':                 'NICE TO HAVE*',
    'cs.tango.s04.eg1.title':           'e.g Website home page revamp',
    'cs.tango.s04.eg1.li1':             'Refondre le menu de navigation',
    'cs.tango.s04.eg1.li2':             'Améliorer l\'expérience de navigation du smartphones du mois',
    'cs.tango.s04.eg1.li3':             'Réduire les espacements pour augmenter la visibilité des éléments sous-exposés',
    'cs.tango.s04.eg1.nth1':            'Supprimer le dégradé',
    'cs.tango.s04.eg1.nth2':            'Unifier la logique de couleur des CTA',
    'cs.tango.s04.eg1.nth3':            'Revoir les tokens des cards pour gagner en espacement',
    'cs.tango.s04.eg2.title':           'e.g Enjoy stratégie de redirection',
    'cs.tango.s04.eg2.li1':             'Designer un jeu 100% win',
    'cs.tango.s04.eg2.li2':             'Quizz en fin de jeu avec redirection',
    'cs.tango.s04.eg2.nth1':            'Supprimer le dégradé',
    'cs.tango.s04.eg2.nth2':            'Supprimer le CTA rose propre à Enjoy',
    'cs.tango.s04.eg2.nth3':            'Avoir une mini charte des images de lots à uploader',
    'cs.tango.s04.legend':              '* ITÉRATION COURTE, UN COMPOSANT CONSOLIDÉ, UN TOKEN ALIGNÉ',
    'cs.tango.s04.quote':               '"Je n\'ai pas demandé du temps pour refaire le design system. J\'ai utilisé chaque mission comme une occasion de poser une brique propre."',

    'cs.tango.practices.h3':            'Trois pratiques qui ont tenu dans la durée.',
    'cs.tango.pr01.title':              'Feedback dev structuré',
    'cs.tango.pr01.p1':                 'Les développeurs traités comme des utilisateurs du système. Un channel Slack dédié pour remonter les frictions en temps réel. Après chaque composant livré : 3 questions en async :',
    'cs.tango.pr01.li1':                'qu\'est-ce qui t\'a bloqué ?',
    'cs.tango.pr01.li2':                'qu\'est-ce qui était clair ?',
    'cs.tango.pr01.li3':                'qu\'est-ce qui manquait ?',
    'cs.tango.pr01.p2':                 'Session de synthèse en fin de quarter.',
    'cs.tango.pr02.title':              'Mémoire projet dans Figma',
    'cs.tango.pr02.p1':                 'Certains projets disparaissaient des priorités pendant des semaines, puis revenaient avec des incompréhensions. Pour chaque projet en veille : un slide deck Figma comprenant les décisions prises, raisons, contraintes non résolues.',
    'cs.tango.pr02.p2':                 'Quand le projet revenait, l\'équipe avait un point de reprise.',
    'cs.tango.pr03.title':              'Handoff comme co-construction',
    'cs.tango.pr03.p':                  'Chaque composant livré avec ses specs complètes et des annotations. On vérifiait ensemble que l\'implémentation correspondait à l\'intention et que les notes soient suffisamment claires.',

    'cs.tango.concret.label':           'Résultat concret',
    'cs.tango.concret.h2':              'Anticiper. Pour que le prochain projet soit facile à livrer.',
    'cs.tango.concret.intro':           'J\'ai anticipé les composants, incohérents avec l\'identité de marque, qui allaient devoir être revampés. Je les ai traités sans attendre qu\'un projet les force.',
    'cs.tango.concret.sub':             'Cas concret — Refonte Enjoy',
    'cs.tango.concret.body':            'Quand Enjoy est revenue sur la table, j\'avais déjà anticipé les incohérences visuelles de la section. J\'ai posé le besoin de cohérence avec les couleurs et l\'identité globale et toute l\'identité d\'Enjoy a été revue dans le même mouvement. L\'implémentation a été facile parce que le design system avait déjà la flexibilité nécessaire pour absorber ce changement.',
    'cs.tango.concret.stat1.value':     'Anticipé',
    'cs.tango.concret.stat1.label':     'avant la demande',
    'cs.tango.concret.stat2.value':     'Cohérent',
    'cs.tango.concret.stat2.label':     'avec l\'identité globale',
    'cs.tango.concret.stat3.value':     'Fluide',
    'cs.tango.concret.stat3.label':     'à implémenter',
    'cs.tango.concret.quote':           '<em>Decision produit :</em> chaque projet est une occasion de poser une brique propre dans le système, sans bloquer les livraisons en cours.',

    'cs.tango.s05.h2':                  '05 · Ce qui a été construit.',
    'cs.tango.s05.d1.title':            'Architecture composants',
    'cs.tango.s05.d1.p':                '10+ composants "Evolution" avec états complets, variantes et annotations accessibilité — réutilisables sur les 3 plateformes.',
    'cs.tango.s05.d2.title':            'Tokens unifiés',
    'cs.tango.s05.d2.p':                'Couleurs, espacements, typographies et radius alignés entre les trois produits. Le "bon bleu" enfin défini et documenté comme source de vérité.',
    'cs.tango.s05.d3.title':            'Gouvernance & specs',
    'cs.tango.s05.d3.p':                'Conventions de nommage, workflow de contribution et standards de handoff définis et documentés pour l\'équipe engineering.',
    'cs.tango.s05.conclusion':          'Au bout de plusieurs mois, les trois plateformes partageaient enfin un langage visuel commun. Pas parce qu\'on avait lancé un grand projet de refonte — mais parce que chaque livraison avait été traitée comme une occasion de construire quelque chose qui tienne.',

    'cs.tango.s06.h2':                  '06 · Project Spotlights',
    'cs.tango.s06.lead':                'Cinq chantiers distincts, chacun avec ses propres contraintes — et la dualité Masterline/Subscriber en filigrane à chaque fois.',
    'cs.tango.acc.tag.mobile':          'Mobile',
    'cs.tango.acc.tag.high':            'Complexité haute',
    'cs.tango.acc.tag.med':             'Complexité moyenne',
    'cs.tango.acc.label.problem':       'Problème',
    'cs.tango.acc.label.approach':      'Approche',
    'cs.tango.acc.label.before':        'Avant',
    'cs.tango.acc.label.after':         'Après',
    'cs.tango.acc1.title':              'Refonte du Shop in-app',
    'cs.tango.acc1.sub':                'Repenser l\'expérience d\'achat directement dans l\'app mobile',
    'cs.tango.acc1.p':                  'Le shop in-app est un point de conversion critique — c\'est là que les utilisateurs gèrent leurs options, renouvellent leur forfait ou achètent des extras. La version existante manquait de clarté dans la présentation des offres et créait de la friction avant même l\'étape de paiement.',
    'cs.tango.acc1.prob.li1':           'Hiérarchie d\'offres peu claire',
    'cs.tango.acc1.prob.li2':           'Masterline et Subscriber voyaient les mêmes options — sans filtrage par droits',
    'cs.tango.acc1.prob.li3':           'Parcours d\'achat multi-étapes sans indication de progression',
    'cs.tango.acc1.prob.li4':           'États d\'erreur absents ou génériques',
    'cs.tango.acc1.appr.li1':           'Restructuration de l\'architecture par niveau d\'utilisateur',
    'cs.tango.acc1.appr.li2':           'Affichage conditionnel selon le profil (Masterline vs Subscriber)',
    'cs.tango.acc1.appr.li3':           'Indicateur de progression visible à chaque étape',
    'cs.tango.acc1.appr.li4':           'États d\'erreur spécifiques avec messages actionnables',
    'cs.tango.acc1.outcome':            'Parcours validé et implémenté. La distinction Masterline/Subscriber est désormais traduite visuellement à chaque étape — l\'utilisateur comprend ce qu\'il peut faire et pourquoi.',
    'cs.tango.acc2.title':              'Parcours d\'activation Bitdefender',
    'cs.tango.acc2.sub':                'Rendre compréhensible une offre sécurité complexe avec plusieurs partenaires',
    'cs.tango.acc2.p':                  'L\'offre Bitdefender impliquait plusieurs partenaires techniques, des cas d\'usage distincts selon le type d\'appareil, et des contraintes business non modifiables. Le défi : rendre ce parcours compréhensible sans simplifier à outrance.',
    'cs.tango.acc2.prob.li1':           'Offre multi-partenaires difficile à expliquer en 3 écrans',
    'cs.tango.acc2.prob.li2':           'Cas d\'usage différents selon le device',
    'cs.tango.acc2.prob.li3':           'Contraintes CX et légales non négociables',
    'cs.tango.acc2.prob.li4':           'Risque de confusion entre activation et achat',
    'cs.tango.acc2.appr.li1':           'Constraint mapping en amont',
    'cs.tango.acc2.appr.li2':           'Design incrémental : un cas d\'usage à la fois, validé avant le suivant',
    'cs.tango.acc2.appr.li3':           'Ateliers de validation cross-fonctionnels (product, CX, legal, tech)',
    'cs.tango.acc2.appr.li4':           'Documentation Figma du parcours pour les équipes non-design',
    'cs.tango.acc2.outcome':            'Parcours complet maquetté et validé unanimement par management, CX et équipes techniques. Complexité absorbée côté design — invisible côté utilisateur.',
    'cs.tango.acc3.title':              'Refonte du jeu Enjoy',
    'cs.tango.acc3.sub':                'Réengager les utilisateurs via le principal driver de trafic de l\'app',
    'cs.tango.acc3.p':                  'Enjoy est la mécanique de gamification intégrée à MyTango — roue de la fortune, récompenses, challenges. C\'est le principal moteur d\'ouvertures récurrentes. La version existante était visuellement datée et le parcours manquait de clarté.',
    'cs.tango.acc3.prob.li1':           'Mécanique de jeu peu lisible à la première utilisation',
    'cs.tango.acc3.prob.li2':           'Récompenses pas assez visibles ni mémorisables',
    'cs.tango.acc3.prob.li3':           'Expérience identique Masterline/Subscriber malgré des droits différents',
    'cs.tango.acc3.prob.li4':           'Visuels datés ne reflétant plus le design system',
    'cs.tango.acc3.appr.li1':           'Audit UX de l\'existant + benchmark jeux in-app similaires',
    'cs.tango.acc3.appr.li2':           'Refonte de la hiérarchie visuelle — récompense au premier plan',
    'cs.tango.acc3.appr.li3':           'Intégration dans le design system "Evolution"',
    'cs.tango.acc3.appr.li4':           'Adaptation du parcours selon le profil utilisateur',
    'cs.tango.acc3.outcome':            'Trafic qualifié maintenu, note App Store améliorée pendant la période. La mécanique Enjoy contribue directement à la hausse de satisfaction globale observée.',
    'cs.tango.acc4.title':              'Refonte des Démarches in-app',
    'cs.tango.acc4.sub':                'Simplifier un hub de services complexes avec une logique de droits stricte',
    'cs.tango.acc4.p':                  'Les Démarches regroupent toutes les actions de gestion du compte — changement d\'offre, gestion des lignes, portabilité, résiliation. Chaque action a ses propres règles de droit, et la distinction Masterline/Subscriber y est la plus critique.',
    'cs.tango.acc4.prob.li1':           'Hub surchargé — trop d\'actions au même niveau de hiérarchie',
    'cs.tango.acc4.prob.li2':           'Subscriber voyait des actions qu\'il ne pouvait pas effectuer',
    'cs.tango.acc4.prob.li3':           'Messages d\'erreur génériques quand les droits insuffisants',
    'cs.tango.acc4.prob.li4':           'Aucune indication du statut d\'une démarche en cours',
    'cs.tango.acc4.appr.li1':           'Cartographie complète de toutes les démarches × profils',
    'cs.tango.acc4.appr.li2':           'Affichage conditionnel strict selon les droits',
    'cs.tango.acc4.appr.li3':           'Messages explicatifs quand une action est bloquée (et pourquoi)',
    'cs.tango.acc4.appr.li4':           'Indicateurs de statut pour les démarches en cours',
    'cs.tango.acc4.outcome':            'Architecture validée. La logique de droits est désormais traduite en UX — pas juste en règles backend. Réduction des contacts support liés à des actions bloquées sans explication.',
    'cs.tango.acc5.title':              'Dashboard & Funnel tango.lu',
    'cs.tango.acc5.sub':                'Dashboard consommation mobile + refonte du funnel d\'achat web',
    'cs.tango.acc5.tag':                'Mobile + Web',
    'cs.tango.acc5.p':                  'Deux projets traités en parallèle : la refonte du dashboard de consommation mobile — source de feedbacks négatifs récurrents sur l\'App Store — et la simplification du funnel d\'achat web.',
    'cs.tango.acc5.sh1':                'Dashboard mobile',
    'cs.tango.acc5.dash.before.li1':    'Jauges multiples superposées (forfait, roaming, report, saisonnier)',
    'cs.tango.acc5.dash.before.li2':    'Aucune hiérarchie — tout au même niveau visuel',
    'cs.tango.acc5.dash.before.li3':    'Incompréhensible pour l\'utilisateur moyen',
    'cs.tango.acc5.dash.before.li4':    'Feedbacks négatifs récurrents App Store',
    'cs.tango.acc5.dash.after.li1':     'Switch unique entre types de données',
    'cs.tango.acc5.dash.after.li2':     'Données primaires en avant, détails à la demande',
    'cs.tango.acc5.dash.after.li3':     'Interface aérée et lisible',
    'cs.tango.acc5.dash.after.li4':     'Validé unanimement — product, CX, management',
    'cs.tango.acc5.sh2':                'Funnel tango.lu',
    'cs.tango.acc5.funnel.before.li1':  'Configurateur d\'offre visuellement enfoui',
    'cs.tango.acc5.funnel.before.li2':  'USPs sous-exposés, sans ancre',
    'cs.tango.acc5.funnel.before.li3':  'Taux élevé de faux clics sur le CTA principal',
    'cs.tango.acc5.funnel.after.li1':   'Section dédiée par offre avec configuration exposée',
    'cs.tango.acc5.funnel.after.li2':   'USPs surfacés avec description + ancre',
    'cs.tango.acc5.funnel.after.li3':   'Comparaison claire entre offres — validé et implémenté',

    'cs.tango.s07.h2':                  '07 · Ce qui a réellement changé.',
    'cs.tango.s07.lead':                'Le design system était devenu l\'infrastructure sur laquelle tout le reste tournait.',
    'cs.tango.s07.r1.title':            'Décision d\'internalisation',
    'cs.tango.s07.r1.p':                'Mon recrutement faisait partie d\'une décision plus large d\'internaliser le design et de réduire la dépendance aux agences externes. J\'ai contribué à rendre cette décision viable.',
    'cs.tango.s07.r2.title':            'Vélocité dev',
    'cs.tango.s07.r2.p':                'Les équipes dev avançaient plus vite. Le handoff était non ambigu. Zéro improvisation à l\'implémentation. Signal partagé en fin de projet par l\'équipe engineering.',
    'cs.tango.s07.r3.title':            'Satisfaction utilisateurs',
    'cs.tango.s07.r3.p':                'Note App Store améliorée durant la période, corrélée aux refontes UX mobile.',
    'cs.tango.s07.r4.title':            'Cohérence à l\'échelle',
    'cs.tango.s07.r4.p':                'Pour la première fois, trois plateformes partageaient un langage visuel commun. Les nouvelles features pouvaient s\'appuyer sur une fondation fiable.',

    'cs.tango.cta.p':                   'Ce case study est partagé sous NDA. Contactez-moi pour un walkthrough complet en appel.',
    'cs.tango.cta.btn':                 'Planifier un appel →',

    // ── Case Study · Axian ────────────────────────
    'cs.axian.back':               '← Travaux',
    'cs.axian.h1':                 'Concevoir l\'autorité digitale d\'un groupe panafricain opérant sur 5 clusters.',
    'cs.axian.glance.label1':      'Contexte',
    'cs.axian.glance.p1':          'Axian opère dans les télécoms, l\'énergie, l\'immobilier, les services financiers et l\'infrastructure digitale. Chaque filiale avait sa propre direction visuelle. Aucune ne parlait du groupe derrière.',
    'cs.axian.glance.label2':      'Mission',
    'cs.axian.glance.mission':     'Créer une identité unifiée qui reflète l\'ambition du groupe sans effacer les identités des entités.',
    'cs.axian.insight.label':      'Enseignement clé',
    'cs.axian.insight.quote':      'Un groupe qui opère à cette échelle a besoin d\'une identité qui se ressent avant de se lire.',
    'cs.axian.eyebrow.problem':    'Le problème',
    'cs.axian.problem.h2':         'Deux freins à l\'autorité du groupe',
    'cs.axian.problem.p':          'Axian avait la substance. Il lui manquait la forme qui la rend crédible à distance.',
    'cs.axian.blocker1.title':     'Fragmentation visuelle',
    'cs.axian.blocker1.p':         'Chaque filiale communiquait dans sa propre direction. Le groupe Axian était invisible derrière ses entités, un paradoxe pour un groupe dont l\'ambition est précisément d\'être reconnu comme un acteur structurant à l\'échelle du continent.',
    'cs.axian.blocker2.title':     'Absence d\'autorité digitale',
    'cs.axian.blocker2.p':         'Aucun site corporate ne reflétait l\'ambition ou l\'échelle réelle du groupe. La présence digitale ne correspondait pas à la réalité du business, ni à la position qu\'Axian occupe sur les marchés où il opère.',
    'cs.axian.caption.unification':'De la fragmentation à la cohérence',
    'cs.axian.ds.h2':              'Le langage visuel du groupe',
    'cs.axian.ds.p':               'Un système pensé pour être déployable à l\'échelle, sur tous les supports, pour toutes les entités, sans jamais perdre de vue l\'identité du groupe.',
    'cs.axian.ds.colors.title':    'Couleurs',
    'cs.axian.ds.comp.title':      'Architecture de composants multi-entités',
    'cs.axian.ds.comp.p':          'Bibliothèque de composants modulaires, adaptée aux contraintes de chaque filiale : direction visuelle propre, mais socle commun non-négociable.',
    'cs.axian.ds.tokens.title':    'Variables de design déployables',
    'cs.axian.ds.tokens.p':        'Tokens de design partagés : couleurs, espacements, typographies, qui garantissent la cohérence visuelle sur tous les supports et toutes les équipes.',
    'cs.axian.eyebrow.iconography':'Iconographie',
    'cs.axian.caption.laptop':     'Direction artistique, refonte corporate Axian Group',
    'cs.axian.ds.wide.icon':       'Application multi-entités',
    'cs.axian.ds.wide.title':      'Du groupe aux filiales',
    'cs.axian.ds.wide.p':          'Le design system a été déployé sur l\'ensemble de l\'écosystème Axian, couvrant les entités institutionnelles comme les filiales sectorielles.',
    'cs.axian.ds.wide.more':       '+ filiales sectorielles',
    'cs.axian.eyebrow.work':       'Les livrables',
    'cs.axian.work.h2':            'Trois livrables, une seule direction',
    'cs.axian.work.p':             'Chaque livrable s\'adresse à une couche différente du problème. De la fondation visuelle à la présence digitale publique.',
    'cs.axian.del1.title':         'Identité de marque',
    'cs.axian.del1.p':             'Identité de groupe construite pour traverser les frontières, les supports et les entités sans se dégrader. Logo, couleurs, typographie, iconographie, un système cohérent de bout en bout, déployable par n\'importe quelle équipe.',
    'cs.axian.del2.title':         'Système de design',
    'cs.axian.del2.p':             'Système de design complet (composants, tokens, patterns) documenté pour être utilisable par les équipes de toutes les filiales. De la carte de visite au site web, du rapport annuel à la campagne digitale : une seule source de vérité.',
    'cs.axian.del3.title':         'Site corporate',
    'cs.axian.del3.p':             'Refonte complète du site corporate Axian. Architecture de l\'information repensée pour refléter la structure multi-clusters, storytelling corporate, direction artistique alignée, déploiement responsive multi-support.',
    'cs.axian.eyebrow.social':     'Direction artistique · Réseaux sociaux',
    'cs.axian.social.h2':          'La DA déployée sur les réseaux',
    'cs.axian.social.p':           'Une identité visuelle cohérente déclinée sur chaque plateforme, adaptée aux codes de chaque réseau sans jamais perdre l\'ADN du groupe.',
    'cs.axian.eyebrow.outcomes':   'Résultats',
    'cs.axian.outcomes.h2':        'Ce que ça a changé',
    'cs.axian.outcomes.li1':       'Cohérence visuelle déployée sur l\'ensemble des filiales du groupe',
    'cs.axian.outcomes.li2':       'Identité corporate reconnue à l\'international, positionnement pan-africain affirmé',
    'cs.axian.outcomes.li3':       'Refonte complète du site corporate, de la stratégie éditoriale à l\'implémentation finale',
    'cs.axian.outcomes.li4':       'Architecture de l\'information repensée pour refléter la structure multi-clusters',
    'cs.axian.outcomes.li5':       'Direction artistique alignée avec la nouvelle identité de marque du groupe',
    'cs.axian.outcomes.li6':       'Storytelling corporate : histoire du groupe, valeurs, impact pan-africain',
    'cs.axian.outcomes.li7':       'Déploiement responsive multi-support',
    'cs.axian.cta.p':              'Un projet d\'identité ou de présence digitale à construire ?<br>Je suis disponible pour en parler.',
    'cs.axian.cta.btn':            'Prendre un appel',
  ...
  en: {
    ...
    'nav.faq':          'FAQ',
    'nav.discovery':    'Schedule a call',
    'mobilenav.p': 'Available to discuss opportunities',
    'mobilenav.cta' : 'Schedule a call',

    // ── Page About ────────────────────────────────
    'about.hero.label':  'About',
    'about.hero.intro':  'I\'m Jacob — a Senior Product Designer with 10 years of experience designing digital products, systems, and interfaces at scale.',
    'about.hero.p1':     'I started my career in Madagascar at Axian Group one of the largest pan-African conglomerates, active in telecoms, energy and fintech. Over 5 years, I led the complete rebranding of the group, unified 5 business sectors under one visual identity, and contributed to 4 international awards at the Creatives 974 Awards.',
    'about.hero.p2':     'I then joined Tango, Luxembourg\'s leading telecom operator. I designed the UX for both their mobile app (offer management, loyalty, payments) and their e-commerce website maintaining full consistency across both platforms through a shared design system.',
    'about.hero.p3':     'My most recent project: Venue (Yummy Labs / Superbloom), a mobile game with 4M+ players, recognised as Top Sprinter in March 2026.',
    'about.stats.exp':   '10 years',
    'about.stats.exp.label':     'of experience',
    'about.stats.countries':     '3 countries',
    'about.stats.countries.label': 'Madagascar · Luxembourg · France',
    'about.stats.focus':         'SaaS · Fintech',
    'about.stats.focus.label':   'Preferred sectors',
    'about.approach.h2':         'How I work',
    'about.approach.v1.title':   'Problems first',
    'about.approach.v1.desc':    'I don\'t start in Figma. I start by understanding your users, your constraints and your business. The pixels come after.',
    'about.approach.v2.title':   'Real collaboration',
    ...
    'about.faq.cta.sub':         'Let\'s talk directly — free and no commitment.',
    'about.faq.cta.btn':         'Schedule a call',
    'about.cta.h2':              'Available to discuss opportunities',
    'about.cta.p':               'Got a product to build or improve? Book a free 30-minute call — no commitment.',
    'about.cta.btn':             'Check my availability',

    // ── Hero ─────────────────────────────────────
    'h1.1':         'Product designer',
    'hero.quote':   '10 years in design. Madagascar → Luxembourg → France',
    'hero.subtitle':'Self-taught. Proven far from home.<br/> Always leaving my \'digital\' mark 😉.<br/> I transform complex systems into clear and intuitive interfaces. <br> My work focuses on design systems, product clarity, and measurable impact. <br> I use AI to iterate faster, explore solutions, and bridge the gap between idea and product.',
    'hero.cta':     'Check my availability',
    'hero.hint' : ' <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor" style="flex-shrink:0"><path d="M12 4a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm0 4a1 1 0 0 0-1 1v6a1 1 0 0 0 2 0v-6a1 1 0 0 0-1-1zm0-6C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/></svg>' +
    ...
    'quote.text':        'Senior Product Designer <br><span> Complex systems, design systems, and product clarity.</span>',
    ...
    // ── Bandeau principal ─────────────────────────
    'main.h2':      'I work end-to-end, from discovery to shipped product, in close collaboration<span>  with product and engineering teams.</span>',
    'main.subtitle':'Schedule a call. I am available to discuss opportunities',
    ...
    // ── Cases studies ─────────────────────────────
    'casestudies.title':          'Work',
    'casestudies.venue.title':    'Social Layer',
    'casestudies.venue.desc':     'Increasing retention without adding friction or moderation cost.',
    'casestudies.tango.title':    'Mobile App',
    'casestudies.tango.desc':     'Design system governance.',
    'casestudies.tango.hero.locked': 'Design system governance',
    'cs.tango.pw.title':             'Protected case study',
    'cs.tango.pw.sub':               'NDA content — access by request',
    'cs.tango.input.pass':           '<input type="password" id="pw-input" class="pw-input" placeholder="Password" autocomplete="current-password" onkeydown="if(event.key===\'Enter\') checkTangoPassword()" aria-label="Mot de passe" >', 
    'cs.tango.pw.error':             'Incorrect password.',
    'cs.tango.pw.btn':               'View case study →',
    'casestudies.checkout.title':        'Checkout',
    'casestudies.checkout.desc':         'Simplifying the purchase funnel to reduce drop-off.',
    'casestudies.axian.title':           'Brand &amp; Web Design',
    'casestudies.axian.desc':            'Building the digital authority of a pan-African group operating across 5 clusters.',
    ...
    'cs.venue.hero.sub':                'UX Case Study · Mobile Game Design · Retention Strategy · Social Systems · Product Design',
    ...
    'cs.venue.meta.constraint.value':   '2 weeks sprint',
    ...
    'cs.venue.problem.p1':              'She\'s been playing for months. She designs rooms, submits them to be voted on, collects rewards. She\'s engaged. But when she wants feedback or recognition, the product has nothing to offer. So she goes elsewhere.',
    ...
    'cs.venue.problem.conclusion.lead':      'The product lacked a social feedback loop that made user activity feel meaningful.',
    'cs.venue.problem.conclusion.sub':       'This created a structural UX problem:',
    'cs.venue.problem.conclusion.li1':       'No in-product recognition after submission',
    'cs.venue.problem.conclusion.li2':       'No visibility into engagement from other players',
    'cs.venue.problem.conclusion.li3':       'No persistent social context to return to',
    'cs.venue.problem.conclusion.challenge': 'UX Challenge: How might we design social features that improve retention without adding friction or moderation complexity?',
    'cs.venue.h2.insight':              'The Insight',
    'cs.venue.insight.lead':            'Most social features in mobile games rely on explicit actions: joining groups, adding friends, or posting content. But this creates friction. Players like Beth don’t want to perform social interaction;  they want to feel it naturally.',
    ...
    'cs.venue.challenge.lead':          'SuperBloom’s brief: design a group-based social system for Venue that encourages collaboration, Improves player retention (D7 / D30), requires zero moderation and ddds no extra cognitive load',
    ...
    'cs.venue.principle.1.title':       'No toxicity by design',
    ...
    'cs.venue.principle.2.title':       'No penalty for absence',
    ...
    'cs.venue.principle.3.title':       'Passive participation',
    ...
    'cs.venue.principle.4.title':       'Collective progression',
    ...
    'cs.venue.h2.joining':              'The Joining Mechanic:"Frictionless Belonging"',
    ...
    'cs.venue.joining.blockquote':      '<strong> Product decision:</strong> Removed all opt-in steps to eliminate friction and increase early engagement.',
    ...
    'cs.venue.d7.blockquote':           '<strong> Product decision:</strong> Integrated feature discovery into existing user flow instead of using notifications or external prompts.',
    'cs.venue.h2.currencies':           'Retention System Design',
    ...
    'cs.venue.currencies.blockquote':   '<strong> Product decision:</strong> Separated engagement loops (weekly vs long-term) to support both retention cycles.',
    ...
    'cs.venue.voting.blockquote':       '<strong> Product decision:</strong> Eliminated free-text interactions to remove moderation needs while preserving emotional feedback.',  
    ...
    'cs.venue.h2.rollout':              'How This Would Roll Out',
    'cs.venue.rollout.lead':            'This system wasn\'t designed to be shipped all at once.',
    'cs.venue.rollout.body':            'It\'s structured to be introduced progressively; each phase validating a different layer of the experience before adding complexity.',
    'cs.venue.phase1.label':            'Phase 1',
    'cs.venue.phase1.badge':            'Validate belonging (D7)',
    'cs.venue.phase1.desc':             'Start with lightweight Studio assignment and passive contribution.',
    'cs.venue.phase1.goal':             'Test shared progress · Early retention',
    'cs.venue.phase2.label':            'Phase 2',
    'cs.venue.phase2.badge':            'Deepen engagement',
    'cs.venue.phase2.desc':             'Introduce reactions and gallery visibility.',
    'cs.venue.phase2.goal':             'Increase contribution frequency',
    'cs.venue.phase3.label':            'Phase 3',
    'cs.venue.phase3.badge':            'Build long-term attachment (D30)',
    'cs.venue.phase3.desc':             'Add persistent progression (Studio rooms, Arrow system).',
    'cs.venue.phase3.goal':             'Create identity · Long-term retention',
    'cs.venue.rollout.closing':         'Each phase builds on the previous one, turning a design concept into a measurable system.',
    ...
    'cs.venue.learned.1.desc1':        'Breaking down user journeys into key moments (join, contribute, stay, leave) improves decision-making.',
    'cs.venue.learned.2.title':        'Good references are systems, not screens.',
    'cs.venue.learned.2.desc1':        'Looking beyond design feeds shifted the question from "how should this look?" to "what problem has already been solved at scale?"',
    ...
    'cs.venue.learned.3.desc1':        'Using Claude Code enabled rapid prototyping and faster iteration cycles between concept and implementation.',
    'cs.venue.h2.quotes':              'Key Principles I\'ll Carry Forward',
    'cs.venue.quote.1':                'Design systems that prevent problems, not manage them',
    'cs.venue.quote.2':                'Reduce friction by removing unnecessary decisions',
    'cs.venue.quote.3':                'Build belonging through behavior, not explicit interaction',
    'cs.venue.h2.tools':               'Tools &amp; Methods',
    'cs.venue.tools.pill1':            'Figma (UI/UX design, prototyping)',
    'cs.venue.tools.pill2':            'Claude Code (rapid prototyping, interaction testing)',
    'cs.venue.tools.pill3':            'System design thinking',
    'cs.venue.tools.pill4':            'User journey mapping',
    ...
    'cs.venue.tldr.title':             'TL;DR',
    'cs.venue.tldr.problem.label':     'Problem:',
    'cs.venue.tldr.problem.value':     'Lack of social feedback loop in a mobile game',
    'cs.venue.tldr.solution.label':    'Solution:',
    'cs.venue.tldr.solution.value':    'Passive social system embedded in gameplay',
    'cs.venue.tldr.impact.label':      'Impact:',
    'cs.venue.tldr.impact.value':      'Improved D7 and D30 retention',
    'cs.venue.tldr.approach.label':    'Approach:',
    'cs.venue.tldr.approach.value':    'Rapid prototyping using Figma and Claude Code',
    ...
    // ── Case Study · Tango Design System ─────────────────
    'cs.tango.back':                    '← Work',
    'cs.tango.hero.h1':                 'Unify three platforms.<br>Build the system that holds.',
    'cs.tango.hero.sub':                'Tango Design System — Feb 2024 — Aug 2025',
    'cs.tango.nda.text':                'This case study is shared under NDA. Screenshots and metrics shown are public or anonymised. Internal data, unreleased features and financial information have been omitted.',

    'cs.tango.tldr.h2':                 'TL;DR',
    'cs.tango.tldr.card1.label':        'Problem:',
    'cs.tango.tldr.card1.p':            'Three platforms, three visual identities, no shared language. Design debt accumulated with every delivery.',
    'cs.tango.tldr.card2.label':        'Solution:',
    'cs.tango.tldr.card2.p':            'A unified design system built progressively, in parallel with product priorities — no big bang, no blocking the teams.',
    'cs.tango.tldr.card3.label':        'Impact:',
    'cs.tango.tldr.card3.p':            'Visual consistency across 3 platforms. Unified brand identity. Smooth implementation on subsequent projects.',
    'cs.tango.tldr.card4.label':        'Approach:',
    'cs.tango.tldr.card4.p':            'Short iterations, structured dev feedback, anticipating components that would need revamping before projects forced the issue.',
    ...
    'cs.tango.meta.company.value':      'Tango Luxembourg (Telecom internet & mobile)',
    'cs.tango.meta.constraint.label':   'CONSTRAINT',
    'cs.tango.meta.constraint.value':   'System deemed "done" by 2 agencies · Non-negotiable product priorities · Solo designer',
    'cs.tango.meta.deliverables.label': 'DELIVERABLES',
    'cs.tango.meta.deliverables.value': 'Design system · "Evolution" components · Unified tokens · Handoff specs · Project slide decks',
    'cs.tango.meta.period.label':       'PERIOD',
    'cs.tango.meta.period.value':       'Feb 2024 — Aug 2025 · 1 year 7 months',

    'cs.tango.stats.s1.label':          'unified platforms',
    'cs.tango.stats.s2.label':          'dev velocity',
    'cs.tango.stats.s3.label':          'user satisfaction',

    'cs.tango.s01.label':               '01 · Context',
    'cs.tango.s01.h2':                  'Solo designer. Three products. Simultaneously.',
    'cs.tango.s01.intro':               'Tango is Luxembourg\'s leading mobile and internet telecom operator.<br>Goal: internalise design to break dependency on external agencies and deliver across 3 platforms in parallel.',
    'cs.tango.s01.card1.label':         'My role',
    'cs.tango.s01.card1.p':             'Product Designer embedded in a cross-functional team — PMs, engineers, CX analysts. Responsible for mobile UX, web experience and design system governance.',
    'cs.tango.s01.card2.label':         'Starting point',
    'cs.tango.s01.card2.p':             '3 Figma files from 2 different agencies. No shared tokens. No component governance. No handoff standards. Each platform had its own visual logic.',
    'cs.tango.s01.card3.label':         'Scope',
    'cs.tango.s01.card3.p':             'MyTango App (mobile) · tango.lu (e-commerce) · Customer Self-Care Portal · Design system spanning all 3 products.',
    'cs.tango.s01.card4.label':         'Method',
    'cs.tango.s01.card4.p':             'Agile. Weekly cross-functional workshops. Iterations driven by CX data, App Store reviews and stakeholder feedback.',

    'cs.tango.s02.label':               '02 · Users',
    'cs.tango.s02.h2':                  'A Tango specificity.<br>Two types of users.',
    'cs.tango.s02.intro':               'Every feature had to work for two profiles with fundamentally different permissions and behaviours. Ignoring this duality means shipping a product that breaks in production.',
    'cs.tango.s02.step1.title':         'Masterline',
    'cs.tango.s02.step1.p':             'Main account with full rights. Requires authentication. Every critical flow is designed around this profile first.',
    'cs.tango.s02.step1bis.title':      'Masterline subscriber view',
    'cs.tango.s02.step1bis.p':          'Main account when operating on a sub-account.',
    'cs.tango.s02.step2.title':         'Subscriber',
    'cs.tango.s02.step2.p':             'sub-account with restricted rights. Every feature requires a Subscriber version — with its own display constraints and permission rules.',
    'cs.tango.s02.impact.label':        'Impact on design',
    'cs.tango.s02.impact.p':            'Every screen, every flow, every component had to be thought through twice. What information is relevant, what action is permitted, what error message appears, and how to transition cleanly between the two states. This duality runs through every project below.',

    'cs.tango.s03.label':               '03 · Design System',
    'cs.tango.s03.h2':                  'Building the system<br>while juggling priorities.',
    'cs.tango.s03.intro':               'The design system wasn\'t built all at once. It was built despite product priorities — progressively, methodically, feature after feature.',
    'cs.tango.s03.sit.label':           'Situation',
    'cs.tango.s03.sit.h3':              'Three products. Three identities. Zero consistency.',
    'cs.tango.s03.sit.body':            'Tango had invested in three distinct platforms, designed at different times by different teams. The visible result: mismatched colour codes, gradients unique to each product, tokens that didn\'t talk to each other. The issue reached management in its simplest form — <em class="cs-tango-emphasis">"it\'s not the right blue."</em>',
    'cs.tango.s03.card1.title':         'Unmatched colours',
    'cs.tango.s03.card1.p':             'Each platform had its own colour values. The same Tango blue existed in 3 variations depending on where you looked.',
    'cs.tango.s03.card2.title':         'Site-specific gradients',
    'cs.tango.s03.card2.p':             'The website used a colour gradient absent from all other products — visually inconsistent, never challenged.',
    'cs.tango.s03.card3.title':         'Unshared tokens',
    'cs.tango.s03.card3.p':             'The app and website dev teams worked in silos. No shared tokens, therefore no shared source of truth.',
    'cs.tango.s03.screen1.label':       'Customer Self-Care',
    'cs.tango.s03.screen2.label':       'MyTango App',
    'cs.tango.s03.screen3.label':       'tango.lu',
    'cs.tango.s03.res.label':           'Resistance',
    'cs.tango.s03.res.h3':              'The system was "done". Two agencies had said so.',
    'cs.tango.s03.res.body':            'The first resistance was positional. The design system was considered delivered. Proposing to rework it meant questioning an already-validated investment. A demonstration was needed, not a debate.',

    'cs.tango.s04.label':               '04 · Approach',
    'cs.tango.s04.h2':                  'No big bang.<br>One visible first brick.',
    'cs.tango.s04.intro':               'I started with a precise, argued change: remove the colour gradient from the website. Once validated, it opened the conversation about broader unification. Everything else was built the same way — a short iteration, one consolidated component, one aligned token — without ever halting ongoing deliveries.',
    'cs.tango.s04.mh':                  'MUST HAVE',
    'cs.tango.s04.nth':                 'NICE TO HAVE*',
    'cs.tango.s04.eg1.title':           'e.g Website home page revamp',
    'cs.tango.s04.eg1.li1':             'Redesign the navigation menu',
    'cs.tango.s04.eg1.li2':             'Improve the phone-of-the-month browsing experience',
    'cs.tango.s04.eg1.li3':             'Reduce spacing to increase visibility of under-exposed elements',
    'cs.tango.s04.eg1.nth1':            'Remove the gradient',
    'cs.tango.s04.eg1.nth2':            'Unify CTA colour logic',
    'cs.tango.s04.eg1.nth3':            'Revisit card tokens to improve spacing',
    'cs.tango.s04.eg2.title':           'e.g Enjoy redirect strategy',
    'cs.tango.s04.eg2.li1':             'Design a 100% win game',
    'cs.tango.s04.eg2.li2':             'End-of-game quiz with redirect',
    'cs.tango.s04.eg2.nth1':            'Remove the gradient',
    'cs.tango.s04.eg2.nth2':            'Remove the Enjoy-specific pink CTA',
    'cs.tango.s04.eg2.nth3':            'Create a mini image charter for batch uploads',
    'cs.tango.s04.legend':              '* SHORT ITERATION, ONE CONSOLIDATED COMPONENT, ONE ALIGNED TOKEN',
    'cs.tango.s04.quote':               '"I never asked for time to rebuild the design system. I used every project as an opportunity to lay one clean brick."',

    'cs.tango.practices.h3':            'Three practices that stood the test of time.',
    'cs.tango.pr01.title':              'Structured dev feedback',
    'cs.tango.pr01.p1':                 'Developers treated as users of the system. A dedicated Slack channel to flag friction in real time. After each component delivered: 3 async questions:',
    'cs.tango.pr01.li1':                'what blocked you?',
    'cs.tango.pr01.li2':                'what was clear?',
    'cs.tango.pr01.li3':                'what was missing?',
    'cs.tango.pr01.p2':                 'Synthesis session at end of quarter.',
    'cs.tango.pr02.title':              'Project memory in Figma',
    'cs.tango.pr02.p1':                 'Some projects dropped off the priority list for weeks, then came back with misunderstandings. For every shelved project: a Figma slide deck covering decisions made, reasons, unresolved constraints.',
    'cs.tango.pr02.p2':                 'When the project came back, the team had a restart point.',
    'cs.tango.pr03.title':              'Handoff as co-creation',
    'cs.tango.pr03.p':                  'Every component delivered with full specs and annotations. We verified together that the implementation matched the intent and that the notes were clear enough.',

    'cs.tango.concret.label':           'Concrete result',
    'cs.tango.concret.h2':              'Anticipate. So the next project is easy to ship.',
    'cs.tango.concret.intro':           'I anticipated the components — inconsistent with the brand identity — that would inevitably need revamping. I addressed them without waiting for a project to force the issue.',
    'cs.tango.concret.sub':             'Concrete case — Enjoy redesign',
    'cs.tango.concret.body':            'When Enjoy came back on the table, I had already anticipated the section\'s visual inconsistencies. I framed the need for consistency with colours and global identity, and the entire Enjoy identity was reviewed in the same motion. Implementation was easy because the design system already had the flexibility to absorb the change.',
    'cs.tango.concret.stat1.value':     'Anticipated',
    'cs.tango.concret.stat1.label':     'before the request',
    'cs.tango.concret.stat2.value':     'Consistent',
    'cs.tango.concret.stat2.label':     'with the global identity',
    'cs.tango.concret.stat3.value':     'Smooth',
    'cs.tango.concret.stat3.label':     'to implement',
    'cs.tango.concret.quote':           '<em>Product decision:</em> every project is an opportunity to lay one clean brick in the system, without blocking ongoing deliveries.',

    'cs.tango.s05.h2':                  '05 · What was built.',
    'cs.tango.s05.d1.title':            'Component architecture',
    'cs.tango.s05.d1.p':                '10+ "Evolution" components with full states, variants and accessibility annotations — reusable across all 3 platforms.',
    'cs.tango.s05.d2.title':            'Unified tokens',
    'cs.tango.s05.d2.p':                'Colours, spacing, typography and radius aligned across all three products. The "right blue" finally defined and documented as the source of truth.',
    'cs.tango.s05.d3.title':            'Governance & specs',
    'cs.tango.s05.d3.p':                'Naming conventions, contribution workflow and handoff standards defined and documented for the engineering team.',
    'cs.tango.s05.conclusion':          'After several months, all three platforms finally shared a common visual language. Not because a major redesign project had been launched — but because every delivery had been treated as an opportunity to build something that holds.',

    'cs.tango.s06.h2':                  '06 · Project Spotlights',
    'cs.tango.s06.lead':                'Five distinct projects, each with its own constraints — and the Masterline/Subscriber duality running through every one of them.',
    'cs.tango.acc.tag.mobile':          'Mobile',
    'cs.tango.acc.tag.high':            'High complexity',
    'cs.tango.acc.tag.med':             'Medium complexity',
    'cs.tango.acc.label.problem':       'Problem',
    'cs.tango.acc.label.approach':      'Approach',
    'cs.tango.acc.label.before':        'Before',
    'cs.tango.acc.label.after':         'After',
    'cs.tango.acc1.title':              'In-app Shop redesign',
    'cs.tango.acc1.sub':                'Rethinking the purchase experience directly inside the mobile app',
    'cs.tango.acc1.p':                  'The in-app shop is a critical conversion point — where users manage their options, renew their plan or buy extras. The existing version lacked clarity in how offers were presented and created friction even before the payment step.',
    'cs.tango.acc1.prob.li1':           'Unclear offer hierarchy',
    'cs.tango.acc1.prob.li2':           'Masterline and Subscriber saw the same options — without rights-based filtering',
    'cs.tango.acc1.prob.li3':           'Multi-step purchase flow with no progress indicator',
    'cs.tango.acc1.prob.li4':           'Error states absent or generic',
    'cs.tango.acc1.appr.li1':           'Architecture restructured by user permission level',
    'cs.tango.acc1.appr.li2':           'Conditional display based on profile (Masterline vs Subscriber)',
    'cs.tango.acc1.appr.li3':           'Visible progress indicator at every step',
    'cs.tango.acc1.appr.li4':           'Specific error states with actionable messages',
    'cs.tango.acc1.outcome':            'Flow validated and implemented. The Masterline/Subscriber distinction is now visually translated at every step — the user understands what they can do and why.',
    'cs.tango.acc2.title':              'Bitdefender activation flow',
    'cs.tango.acc2.sub':                'Making a complex multi-partner security offer understandable',
    'cs.tango.acc2.p':                  'The Bitdefender offer involved multiple technical partners, distinct use cases by device type, and non-negotiable business constraints. The challenge: make this flow understandable without oversimplifying.',
    'cs.tango.acc2.prob.li1':           'Multi-partner offer hard to explain in 3 screens',
    'cs.tango.acc2.prob.li2':           'Different use cases depending on the device',
    'cs.tango.acc2.prob.li3':           'Non-negotiable CX and legal constraints',
    'cs.tango.acc2.prob.li4':           'Risk of confusion between activation and purchase',
    'cs.tango.acc2.appr.li1':           'Constraint mapping upfront',
    'cs.tango.acc2.appr.li2':           'Incremental design: one use case at a time, validated before the next',
    'cs.tango.acc2.appr.li3':           'Cross-functional validation workshops (product, CX, legal, tech)',
    'cs.tango.acc2.appr.li4':           'Figma documentation of the flow for non-design teams',
    'cs.tango.acc2.outcome':            'Complete flow mocked up and unanimously validated by management, CX and technical teams. Complexity absorbed by design — invisible to the user.',
    'cs.tango.acc3.title':              'Enjoy game redesign',
    'cs.tango.acc3.sub':                'Re-engaging users through the app\'s primary traffic driver',
    'cs.tango.acc3.p':                  'Enjoy is the gamification mechanic built into MyTango — wheel of fortune, rewards, challenges. It\'s the main driver of recurring opens. The existing version was visually dated and the flow lacked clarity.',
    'cs.tango.acc3.prob.li1':           'Game mechanic hard to understand on first use',
    'cs.tango.acc3.prob.li2':           'Rewards not visible or memorable enough',
    'cs.tango.acc3.prob.li3':           'Identical Masterline/Subscriber experience despite different rights',
    'cs.tango.acc3.prob.li4':           'Dated visuals no longer reflecting the design system',
    'cs.tango.acc3.appr.li1':           'UX audit of existing + benchmark of similar in-app games',
    'cs.tango.acc3.appr.li2':           'Visual hierarchy redesign — reward front and centre',
    'cs.tango.acc3.appr.li3':           'Integration into the "Evolution" design system',
    'cs.tango.acc3.appr.li4':           'Flow adapted based on user profile',
    'cs.tango.acc3.outcome':            'Qualified traffic maintained, App Store rating improved during the period. The Enjoy mechanic directly contributed to the overall satisfaction increase observed.',
    'cs.tango.acc4.title':              'Démarches in-app redesign',
    'cs.tango.acc4.sub':                'Simplifying a complex service hub with strict permission logic',
    'cs.tango.acc4.p':                  'Démarches groups all account management actions — plan change, line management, number portability, cancellation. Every action has its own permission rules, and the Masterline/Subscriber distinction is most critical here.',
    'cs.tango.acc4.prob.li1':           'Overloaded hub — too many actions at the same hierarchy level',
    'cs.tango.acc4.prob.li2':           'Subscriber saw actions they couldn\'t perform',
    'cs.tango.acc4.prob.li3':           'Generic error messages when permissions were insufficient',
    'cs.tango.acc4.prob.li4':           'No status indication for ongoing processes',
    'cs.tango.acc4.appr.li1':           'Full mapping of all actions × profiles',
    'cs.tango.acc4.appr.li2':           'Strict conditional display based on permissions',
    'cs.tango.acc4.appr.li3':           'Explanatory messages when an action is blocked (and why)',
    'cs.tango.acc4.appr.li4':           'Status indicators for in-progress requests',
    'cs.tango.acc4.outcome':            'Architecture validated. Permission logic is now translated into UX — not just backend rules. Reduction of support contacts from actions blocked without explanation.',
    'cs.tango.acc5.title':              'Dashboard & Funnel tango.lu',
    'cs.tango.acc5.sub':                'Mobile consumption dashboard + web purchase funnel redesign',
    'cs.tango.acc5.tag':                'Mobile + Web',
    'cs.tango.acc5.p':                  'Two projects handled in parallel: the redesign of the mobile consumption dashboard — a recurring source of negative App Store feedback — and the simplification of the web purchase funnel.',
    'cs.tango.acc5.sh1':                'Mobile dashboard',
    'cs.tango.acc5.dash.before.li1':    'Multiple overlapping gauges (plan, roaming, rollover, seasonal)',
    'cs.tango.acc5.dash.before.li2':    'No hierarchy — everything at the same visual level',
    'cs.tango.acc5.dash.before.li3':    'Incomprehensible for the average user',
    'cs.tango.acc5.dash.before.li4':    'Recurring negative App Store feedback',
    'cs.tango.acc5.dash.after.li1':     'Single toggle between data types',
    'cs.tango.acc5.dash.after.li2':     'Primary data front and centre, details on demand',
    'cs.tango.acc5.dash.after.li3':     'Clean, readable interface',
    'cs.tango.acc5.dash.after.li4':     'Unanimously validated — product, CX, management',
    'cs.tango.acc5.sh2':                'Funnel tango.lu',
    'cs.tango.acc5.funnel.before.li1':  'Offer configurator visually buried',
    'cs.tango.acc5.funnel.before.li2':  'USPs under-exposed, no anchor',
    'cs.tango.acc5.funnel.before.li3':  'High rate of false clicks on the main CTA',
    'cs.tango.acc5.funnel.after.li1':   'Dedicated section per offer with exposed configuration',
    'cs.tango.acc5.funnel.after.li2':   'USPs surfaced with description + anchor',
    'cs.tango.acc5.funnel.after.li3':   'Clear comparison between offers — validated and implemented',

    'cs.tango.s07.h2':                  '07 · What actually changed.',
    'cs.tango.s07.lead':                'The design system had become the infrastructure everything else ran on.',
    'cs.tango.s07.r1.title':            'Internalisation decision',
    'cs.tango.s07.r1.p':                'My hiring was part of a broader decision to internalise design and reduce dependency on external agencies. I helped make that decision viable.',
    'cs.tango.s07.r2.title':            'Dev velocity',
    'cs.tango.s07.r2.p':                'Dev teams moved faster. Handoff was unambiguous. Zero improvisation at implementation. Signal shared at end of project by the engineering team.',
    'cs.tango.s07.r3.title':            'User satisfaction',
    'cs.tango.s07.r3.p':                'App Store rating improved during the period, correlated with the mobile UX redesigns.',
    'cs.tango.s07.r4.title':            'Consistency at scale',
    'cs.tango.s07.r4.p':                'For the first time, three platforms shared a common visual language. New features could rely on a reliable foundation.',

    'cs.tango.cta.p':                   'This case study is shared under NDA. Contact me for a full walkthrough on a call.',
    'cs.tango.cta.btn':                 'Schedule a call →',

    // ── Case Study · Axian ────────────────────────
    'cs.axian.back':               '← Work',
    'cs.axian.h1':                 'Designing the digital authority of a pan-African group operating across 5 clusters.',
    'cs.axian.glance.label1':      'Context',
    'cs.axian.glance.p1':          'Axian operates in telecoms, energy, real estate, financial services and digital infrastructure. Each subsidiary had its own visual direction. None of them communicated the group behind them.',
    'cs.axian.glance.label2':      'Mission',
    'cs.axian.glance.mission':     'Create a unified identity that reflects the group\'s ambition without erasing the individual identities of each entity.',
    'cs.axian.insight.label':      'Key Insight',
    'cs.axian.insight.quote':      'A group that operates at this scale needs an identity that can be felt before it\'s read.',
    'cs.axian.eyebrow.problem':    'The Problem',
    'cs.axian.problem.h2':         'Two blockers to the group\'s authority',
    'cs.axian.problem.p':          'Axian had the substance. It lacked the form that makes it credible from a distance.',
    'cs.axian.blocker1.title':     'Visual fragmentation',
    'cs.axian.blocker1.p':         'Each subsidiary communicated in its own visual direction. The Axian Group was invisible behind its entities — a paradox for a group whose ambition is precisely to be recognised as a structuring force across the continent.',
    'cs.axian.blocker2.title':     'Lack of digital authority',
    'cs.axian.blocker2.p':         'No corporate website reflected the actual ambition or scale of the group. The digital presence did not match the business reality, nor the position Axian holds in the markets where it operates.',
    'cs.axian.caption.unification':'From fragmentation to coherence',
    'cs.axian.ds.h2':              'The group\'s visual language',
    'cs.axian.ds.p':               'A system designed to be deployable at scale, across all media, for all entities, without ever losing sight of the group\'s identity.',
    'cs.axian.ds.colors.title':    'Colours',
    'cs.axian.ds.comp.title':      'Multi-entity component architecture',
    'cs.axian.ds.comp.p':          'A library of modular components, adapted to each subsidiary\'s constraints: their own visual direction, but a non-negotiable shared foundation.',
    'cs.axian.ds.tokens.title':    'Deployable design variables',
    'cs.axian.ds.tokens.p':        'Shared design tokens — colours, spacing, typography — ensuring visual consistency across all media and all teams.',
    'cs.axian.eyebrow.iconography':'Iconography',
    'cs.axian.caption.laptop':     'Art direction, corporate redesign — Axian Group',
    'cs.axian.ds.wide.icon':       'Multi-entity rollout',
    'cs.axian.ds.wide.title':      'From group to subsidiaries',
    'cs.axian.ds.wide.p':          'The design system was deployed across the entire Axian ecosystem, covering both institutional entities and sector-specific subsidiaries.',
    'cs.axian.ds.wide.more':       '+ sector subsidiaries',
    'cs.axian.eyebrow.work':       'The Work',
    'cs.axian.work.h2':            'Three deliverables, one direction',
    'cs.axian.work.p':             'Each deliverable addresses a different layer of the problem. From visual foundations to public digital presence.',
    'cs.axian.del1.title':         'Corporate Identity',
    'cs.axian.del1.p':             'A group identity built to cross borders, media and entities without degrading. Logo, colours, typography, iconography — a coherent system end-to-end, deployable by any team.',
    'cs.axian.del2.title':         'Design System',
    'cs.axian.del2.p':             'A complete design system (components, tokens, patterns) documented for use by every subsidiary\'s teams. From business cards to websites, from annual reports to digital campaigns: one single source of truth.',
    'cs.axian.del3.title':         'Corporate Website',
    'cs.axian.del3.p':             'Complete redesign of the Axian corporate website. Information architecture rethought to reflect the multi-cluster structure, corporate storytelling, aligned art direction, responsive multi-device deployment.',
    'cs.axian.eyebrow.social':     'Art Direction · Social',
    'cs.axian.social.h2':          'Visual direction deployed across social media',
    'cs.axian.social.p':           'A consistent visual identity adapted for each platform, tailored to each network\'s codes without ever losing the group\'s DNA.',
    'cs.axian.eyebrow.outcomes':   'Outcomes',
    'cs.axian.outcomes.h2':        'What changed',
    'cs.axian.outcomes.li1':       'Visual consistency deployed across all group subsidiaries',
    'cs.axian.outcomes.li2':       'Corporate identity recognised internationally, pan-African positioning affirmed',
    'cs.axian.outcomes.li3':       'Complete corporate website redesign, from editorial strategy to final implementation',
    'cs.axian.outcomes.li4':       'Information architecture redesigned to reflect the multi-cluster structure',
    'cs.axian.outcomes.li5':       'Art direction aligned with the group\'s new brand identity',
    'cs.axian.outcomes.li6':       'Corporate storytelling: group history, values, pan-African impact',
    'cs.axian.outcomes.li7':       'Responsive multi-device deployment',
    'cs.axian.cta.p':              'An identity or digital presence project to build?<br>I\'m available to discuss it.',
    'cs.axian.cta.btn':            'Schedule a call',
...
function switchLanguage(lang) {
  ...
  document.querySelectorAll('[data-i18n]').forEach((el) => {
    ...
    if (el.tagName === 'INPUT' || el.tagName === 'TEXTAREA') {
     ...
     if (typeof syncMobileLangSwitcher === 'function') syncMobileLangSwitcher();
  });
