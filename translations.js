...
const translations = {
  ...
  fr: {
    ...
    'portfolio.tango_app.desc':     'Tango est un opérateur télécom luxembourgeois avec une app mobile permettant la gestion des offres, des paiements, et des services additionnels.<span class="mobile-hidden"><br/> Mission : refondre l\'expérience de l\'app mobile pour résoudre des frictions critiques, améliorer la satisfaction client et accélérer les développements.</span>',
    'portfolio.tango_app.insights': 'Réalisations clés :',
    'portfolio.tango_app.btn1':     'Résolution d\'une friction récurrente',
