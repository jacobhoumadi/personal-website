...
const SLIDE_TITLES_I18N = {
  ...
  fr: ['Jacob Houmadi','Mon Parcours','Deux Personnes','Localhost','Comment Je Pense','Singularité','Communauté','Axian — Contexte','Afrixian','Le Grand Saut','Tango — Contexte','Tango — La Décision','Pourquoi Hospitable ?','CTA'],
  mg: ['Jacob Houmadi','Ny Diako','Olona Roa','Localhost','Ny Fisainako','Singularité','Vondron\'olona','Axian — Tontolon\'asa','Afrixian','Ilay vikina','Tango — Tontolon\'asa','Tango — Fanapahan-kevitra','Nahoana no i Hospitable ?','Fanasàna anao']
};
...
const T = {
  en: {
    ...
    'tango.s3': 'Dashboard',
    'tango.p1': 'One side wanted better wording.<br>I wanted something you understand before you finish opening the app.',
    ...
    'tooltip.comm.solidarity' :'Solidarity actions · Malagasy Team Leapers',
    'tooltip.agroforestry':    'Applied on a small plot in Madagascar — long-term ambition: scale it.',
    'tooltip.axian.acters' :   'Acters program, supported families in social reintegration',
    'tooltip.axian.snacks':    'Friday mornings were the best part of the week',
    'tooltip.axian.foot' :     'Axian Corporate Games — entities going head to head',
    'tooltip.afrixian':        'African + Axian — an identity built from within.',
    ...
    'tooltip.zombi.vr':        '2,387 zombies down. The UI was solid, and so was the team.',
    'tooltip.dashboard':       'The dashboard that started the debate.',
    'tooltip.home':            'Home',
    /* ── RADAR ── */
    ...
    'radar.caption.26-34':     'Tango briefing — Luxembourg, 2024.',
    'radar.imgcap.17-26.0':    'Activities for underprivileged children during summer holidays 2016',
    'radar.imgcap.17-26.1':    'Movement to express something — solidarity march, 2016',
    'radar.imgcap.17-26.2':    'Completed Subject to Citizen (S2C) leadership training, 2017',
    /* Tags */
  ...
  fr: {
    ...
    'journey.h2': 'Mon parcours, <span class="blue">quatre chapitres.</span>',
    ...
    'tango.h2': 'Deux écoles.<br><span class="blue">Un dashboard</span>',
    'tango.s1': 'Écoles',
    'tango.s2': 'Stakeholders',
    'tango.s3': 'Dashboard',
    'tango.p1': "L'un voulait de meilleures formulations.<br>Moi, je voulais quelque chose qu'on comprend avant même d'avoir fini d'ouvrir l'app.",
    ...
    /* ── TOOLTIPS (images hardcodées) ── */    
    'tooltip.comm.solidarity' :'Actions de solidarité · Malagasy Team Leapers',
    'tooltip.axian.acters' :   'Programme Acters, soutien aux familles dans leur réinsertion sociale',
    'tooltip.agroforestry':    'Appliqué sur une petite parcelle à Madagascar — ambition à long terme : passer à l\'échelle.',
    ...
    'tooltip.axian.foot' :     'Axian Corporate Games — des entités qui s\'affrontent',
    'tooltip.afrixian':        'African + Axian — une identité construite de l\'intérieur.',
    ...
    'tooltip.zombi.vr':        '2 387 zombies éliminés. L\'UI était solide, l\'équipe aussi.',
    'tooltip.dashboard':       'Le dashboard qui a lancé le débat.',
    'tooltip.home':            'Maison',
    /* ── RADAR ── */
    ...
    'radar.caption.26-34':     'Briefing chez Tango — Luxembourg, 2024.',
    'radar.imgcap.17-26.0':    'Activités pour enfants défavorisés pendant les vacances d\'été, 2016',
    'radar.imgcap.17-26.1':    'Un mouvement pour exprimer quelque chose — marche solidaire, 2016',
    'radar.imgcap.17-26.2':    'Formation Subject to Citizen (S2C) en leadership complétée, 2017',
    /* Tags */
  ...
  mg: {
    ...
    'tango.h2': 'Sekoly roa.<br><span class="blue">Dashboard iray</span>',
    'tango.s1': 'Sekoly',
    'tango.s2': 'Mpandray anjara',
    'tango.s3': 'Dashboard',
    'tango.p1': 'Ny ilany iray miteny fa mila arafitra kokoa ny teny.<br>Izaho kosa nila zavatra azonao alohan\'ny vita ny fanokafana ny "application".',
    ...
    'tooltip.comm.solidarity': 'Asa sosialy · Malagasy Team Leapers',
    'tooltip.axian.acters' :   'Fandaharan\'asa Acters, nanohana ny fianakaviana tamin\'ny fampidirana indray teo amin\'ny fiarahamonina',
    'tooltip.agroforestry':    'Nampiarina tamin\'ny tany kely tany Madagasikara — fikasana itomboan\'ny asa.',
    'tooltip.afrixian':        'African + Axian — maha-izy azy naorina tao anatin\'ny.',    
    'tooltip.axian.snacks':    'Ny zoma maraina no fotoana tsara indrindra tamin\'ny herinandro.',
    'tooltip.axian.foot' :     'Axian Corporate Games — fifanandrinan\'ireo orinasa',
    ...
    'tooltip.zombi.vr':        'Zomby 2 387 maty. Mafy orina ny UI, ary mafy kokoa ny ekipa.',
    'tooltip.dashboard':       'Ny dashboard izay niteraka adihevitra.',
    ...
    'radar.caption.26-34':     'Fivoriana miaraka amin\'ny ekipa Tango — Luxembourg, 2024.',
    'radar.imgcap.17-26.0':    'Hetsika ho an\'ny ankizy mahantra nandritra ny fialantsasatra, 2016',
    'radar.imgcap.17-26.1':    'Hetsika mba hanehoana zavatra — fidinana andalambe, 2016',
    'radar.imgcap.17-26.2':    'Nanatanteraka ny fiofanana Subject to Citizen (S2C) ara-pitarihana, 2017',
    /* Tags */
